...
async function checkWeather(city) {
    ...
    // tres imporatnt sinon o nrique de crée un objet JSON avec une errreur avaec le response.json();
    if (response.status == 404) {
        ...
        // Ces méthodes renvoient également des promesses, car elles peuvent impliquer des opérations asynchrones, 
        // tel que le téléchargement et le traitement du corps de la réponse.
